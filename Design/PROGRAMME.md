...
| 1.15 | **Credit and MoMo billing** — days remaining, not francs; the MTN PIN prompt drawn so she can recognise a real one; lapsing explained as a mechanism (we decline, the carrier falls through) rather than a promise; and the grace extends itself when our own aggregator is down | 17         | ●      |
