...
| D0.2 | *v1.1 correction* — the OTP field rebuilt as one input behind six painted slots, per WCAG 2.2 SC 3.3.8 | ● |
| D0.3 | *v1.2 correction* — the dial-code card leads with Copy; tap-to-dial demoted to an Android convenience | ● |
