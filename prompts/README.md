...
prompt, one flow. Nothing else starts until the word *next*.
...
|---|---|---|---|
| **01** | [Foundation & Design System](01-foundation-and-design-system.md) | `design-system.html` | **Ready** |
| 02 | Landing page & public routes | `landing.html` | pending |
| 03 | Sign-up, sign-in, account recovery | `auth.html` | pending |
| 04 | Guided activation | `activation.html` | pending |
...
| Runtime UI deps | Two only: `@radix-ui/react-slot`, `input-otp`. |
